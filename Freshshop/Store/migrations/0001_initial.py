# Generated by Django 2.1.8 on 2019-07-25 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default='images/banner01.jpg', upload_to='buyer/images', verbose_name='图片')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
        ...
        migrations.AddField(
            model_name='goods',
            name='goods_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Store.Goodstype', verbose_name='商品类型id'),
        ),
        migrations.AddField(
            model_name='goods',
            name='store_id',
